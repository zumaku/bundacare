  ...
  DetectionBloc({
      ...
      if (currentState is DetectionSuccess) {
        ...
        try {
          final foodLog = FoodLog(
            ...
            foodName: currentState.result.foodName,
            imageUrl: currentState.imageUrl,
            calories: currentState.result.calories,
            protein: currentState.result.protein,
            fat: currentState.result.fat,
            carbohydrate: currentState.result.carbohydrate,
          );
    ...
    on<DetectionCancelled>((event, emit) async {
      try {
        ...
        debugPrint("Failed to delete image on cancel: $e");
      }
    });
  }
}